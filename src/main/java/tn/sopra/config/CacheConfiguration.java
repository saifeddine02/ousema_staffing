...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tn.sopra.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tn.sopra.repository.UserRepository.USERS_BY_EMAIL_CACHE);
